  ...
  data: function () {
    return {
      ...
      coding: {
          ...
          {id: 1, name: 'CSS', level: '', levelnumber: 100, type: 'web', icon: 'fab fa-css3' },
          {id: 2, name: 'HTML', level: '', levelnumber: 100, type: 'web', icon: 'fab fa-html5' },
          {id: 3, name: 'JavaScript', level: '', levelnumber: 90, type: 'web', icon: 'fab fa-js' },
          {id: 4, name: 'React', level: '', levelnumber: 90, type: 'web', icon: 'fab fa-react' },
          ...
          {id: 7, name: 'Vue.js', level: '', levelnumber: 40, type: 'web', icon: 'fab fa-vuejs' },

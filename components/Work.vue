...
export default {
  ...
  data: function () {
    return {
      ...
      works_en: [
        {id: 1, name: 'Koodiviidakko Oy', time: 'from 1.10.2017', title: 'Senior Front-End developer, Team leader', duties: 'Short changes and developments to websites and webshops as well as specifications and work estimations. Accessibility. Internal Intranet Development. Production Support team superior', image: '/work/kv.png', type: 'web' },
        {id: 2, name: 'Koodiviidakko Oy', time: '1.3.2017-30.9.2017', title: 'Senior Front-End developer', duties: 'Short changes and developments to newsletters, websites and webshops as well as specifications and work estimations. Production Support team leading.', image: '/work/kv.png', type: 'web' },
        {id: 3, name: 'Koodiviidakko Oy', time: '1.2.2016-30.2.2017', title: 'Senior Front-End developer', duties: 'Building websites and webshops. CMS-team leading.', image: '/work/kv.png', type: 'web' },
        {id: 4, name: 'Koodiviidakko Oy', time: '1.9.2008-30.1.2016', title: 'Web-designer', duties: 'Building and designing newsletters, websites and webshops.', image: '/work/kv.png', type: 'web' },
        {id: 5, name: 'Koodiviidakko Oy', time: '1.6.2008-31.8.2008', title: 'Treinee', duties: 'Building newsletters and websites', image: '/work/kv.png', type: 'web' },

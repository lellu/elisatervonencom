  ...
  <section>
    ...
    <div class="cols">
      <div v-for="hobby in hobbies" :key="hobby.id" class="col">
        <p v-if="hobby.link"><a :href="hobby.link" target="_blank" rel="noreferrer"><img :src="hobby.image" alt=""></a></p>
        <p v-else><img :src="hobby.image" alt=""></p>
        <h4 v-if="hobby.link"><a :href="hobby.link" target="_blank" rel="noreferrer">{{ hobby.name }}</a></h4>
